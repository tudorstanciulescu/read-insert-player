...
var apexTeams = variables.connection.redisClusterApex;

var gssApex = variables.connection.gssApex;
...
async function accessSpreadsheet() {
    ...
    const doc = new GoogleSpreadsheet(gssApex);  //aceess the data from specific gss
    ...
    for (let i = 0; i < teams_.length; i++) {
        ...
        db.set(`team:${makeSlug.makeSlug(data1.team_name)}`, teams_redis);  //set team_name as key and insert data 
